        ...
        children: [
          Card(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  const Text('Schedule a Pickup', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                  const SizedBox(height: 16),
                  ListTile(
                    contentPadding: EdgeInsets.zero,
                    leading: const Icon(Icons.location_on),
                    title: Text(_isFetching ? 'Locating...' : _simulatedAddress),
                  ...
                  ListTile(
                    ...
                    title: Text(_selectedDate == null ? 'Select Date & Time' : '${_selectedDate!.day}/${_selectedDate!.month}/${_selectedDate!.year}'),
                    trailing: TextButton(
                      onPressed: () async {
          ...
          Expanded(
            child: requests.isEmpty
                ? Center(child: Text('No pickup requests yet.', style: TextStyle(color: Colors.grey[600])))
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Card(
                        child: ListTile(
                          ...
                          title: Text('${req.scheduledDate.day}/${req.scheduledDate.month}/${req.scheduledDate.year}'),
