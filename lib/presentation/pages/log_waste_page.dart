  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          const Text('Select Waste Category', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
          ...
          const Text('Estimated Quantity (kg)', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
          const SizedBox(height: 16),
          Row(
            children: [
              IconButton(
                onPressed: () => setState(() => _quantity = (_quantity > 0.5) ? _quantity - 0.5 : 0.5),
          ...
          ElevatedButton.icon(
            ...
            style: ElevatedButton.styleFrom(backgroundColor: colors.secondaryContainer, foregroundColor: colors.onSecondaryContainer),
            onPressed: () {},
          ),
          const SizedBox(height: 16),
          ElevatedButton(
            ...
            child: const Text('LOG WASTE', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
          ),
        ],
      ),
    );
